...
import cryptoAnalysisRepository from "../repositories/cryptoAnalysis.repository.js";
...
▸ BITCOIN (BTCUSDT)
  ...
  • Long/Short Ratio: ${BTC.longShortRatio}
...
▸ ETHEREUM (ETHUSDT)
  ...
  • Funding Rate: ${ETH.fundingRate}% 
  • Open Interest: ${Number(ETH.openInterest).toLocaleString()} ETH
  • Long/Short Ratio: ${ETH.longShortRatio}
...

{
  ...
  "news": [
    {
      ...
      "category": "etf | macro | regulation | onchain | technology"
    }
  ],
  ...
  "macro_factors": [ ... ],   // giữ nguyên như sample

  "risk_signals": [ ... ],     // giữ nguyên

  "opportunities": [ ... ],    // giữ nguyên
